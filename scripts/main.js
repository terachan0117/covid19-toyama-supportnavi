...
/*!************************!*\
  !*** ./src/tkoctrl.ts ***!
  \************************/
/*! exports provided: TKOControl */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"TKOControl\", function() { return TKOControl; });\n/* harmony import */ var core_js_modules_es_object_to_string__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.object.to-string */ \"./node_modules/core-js/modules/es.object.to-string.js\");\n/* harmony import */ var core_js_modules_es_object_to_string__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_to_string__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var core_js_modules_es_regexp_exec__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.regexp.exec */ \"./node_modules/core-js/modules/es.regexp.exec.js\");\n/* harmony import */ var core_js_modules_es_regexp_exec__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_regexp_exec__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var core_js_modules_es_regexp_to_string__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! core-js/modules/es.regexp.to-string */ \"./node_modules/core-js/modules/es.regexp.to-string.js\");\n/* harmony import */ var core_js_modules_es_regexp_to_string__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_regexp_to_string__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var core_js_modules_es_string_search__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! core-js/modules/es.string.search */ \"./node_modules/core-js/modules/es.string.search.js\");\n/* harmony import */ var core_js_modules_es_string_search__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_string_search__WEBPACK_IMPORTED_MODULE_3__);\n\n\n\n\nvar TKOControl = /*#__PURE__*/function () {\n  function TKOControl() {}\n\n  TKOControl.changeColor = function changeColor(css) {\n    var head = document.querySelector(\"head\");\n\n    if (head) {\n      var pathEl = head.querySelector(\"meta[data-path]\");\n      var path = pathEl ? pathEl.dataset.path : \".\";\n      var colorDefs = head.querySelectorAll(\"link[data-color-def]\");\n\n      for (var i = 0; i < colorDefs.length; i++) {\n        head.removeChild(colorDefs[i]);\n      }\n\n      var el = document.createElement(\"link\");\n      el.setAttribute(\"rel\", \"stylesheet\");\n      el.setAttribute(\"href\", path + \"/styles/\" + css);\n      el.setAttribute(\"data-color-def\", \"0\");\n      head.appendChild(el);\n      localStorage.setItem(\"tkoctrl-color-1\", css);\n    }\n\n    cssVars();\n  };\n\n  TKOControl.changeColorHandler = function changeColorHandler(event) {\n    var el = event.target;\n    var css = el.dataset.css;\n\n    if (css) {\n      TKOControl.changeColor(css);\n    }\n  };\n\n  TKOControl.applyDefaultColor = function applyDefaultColor() {\n    var css = localStorage.getItem(\"tkoctrl-color-1\");\n\n    if (css) {\n      TKOControl.changeColor(css);\n    } else {\n      cssVars();\n    }\n  };\n\n  TKOControl.textSearchKeyboardHandler = function textSearchKeyboardHandler(event) {\n    if (event.keyCode == 13) {\n      TKOControl.textSearchHandler(event);\n    }\n  };\n\n  TKOControl.textSearchHandler = function textSearchHandler(event) {\n    var el = event.target;\n\n    while (el && !el.classList.contains(\"text-search-combo\")) {\n      el = el.parentElement;\n    }\n\n    if (el) {\n      var href = el.dataset.href;\n\n      if (href) {\n        var textEl = el.querySelector(\".search-text\");\n        var text = \"\";\n\n        if (textEl && textEl.nodeName === \"INPUT\") {\n          text = textEl.value;\n        }\n\n        window.location.assign(href + \"?text=\" + encodeURIComponent(text));\n      }\n    }\n  };\n\n  TKOControl.changeCharSize = function changeCharSize(size) {\n    document.querySelector(\"html\").style.fontSize = size.toString() + \"rem\";\n  };\n\n  TKOControl.applyDefaultCharSize = function applyDefaultCharSize() {\n    var charSize = localStorage.getItem(\"tkoctrl-charsize\");\n\n    if (charSize) {\n      var cs = parseFloat(charSize);\n\n      if (!isNaN(cs)) {\n        TKOControl.changeCharSize(cs);\n      }\n    } else {\n      charSize = \"1.0\";\n    }\n  };\n\n  TKOControl.increaseCharSize = function increaseCharSize() {\n    var charSize = localStorage.getItem(\"tkoctrl-charsize\");\n\n    if (charSize) {\n      var cs = parseFloat(charSize);\n\n      if (!isNaN(cs)) {\n        cs += 0.1;\n        TKOControl.changeCharSize(cs);\n        localStorage.setItem(\"tkoctrl-charsize\", cs.toString());\n      }\n    } else {\n      TKOControl.changeCharSize(1.1);\n      localStorage.setItem(\"tkoctrl-charsize\", \"1.0\");\n    }\n  };\n\n  TKOControl.decreaseCharSize = function decreaseCharSize() {\n    var charSize = localStorage.getItem(\"tkoctrl-charsize\");\n\n    if (charSize) {\n      var cs = parseFloat(charSize);\n\n      if (!isNaN(cs)) {\n        cs -= 0.1;\n        TKOControl.changeCharSize(cs);\n        localStorage.setItem(\"tkoctrl-charsize\", cs.toString());\n      }\n    } else {\n      TKOControl.changeCharSize(0.8);\n      localStorage.setItem(\"tkoctrl-charsize\", \"0.9\");\n    }\n  };\n\n  TKOControl.defaultCharSize = function defaultCharSize() {\n    document.querySelector(\"html\").style.fontSize = \"1.0rem\";\n    localStorage.setItem(\"tkoctrl-charsize\", \"1.0\");\n  };\n\n  TKOControl.openMobileMenu = function openMobileMenu() {\n    var mc = document.querySelector(\".main-content\");\n    mc.classList.add(\"mobile-no-scroll\");\n    mc.classList.add(\"mobile-hidden\");\n    var sb = document.querySelector(\".sidebar\");\n    sb.style.display = \"block\";\n    var sbc = document.querySelector(\".sidebar-content\");\n    sbc.scrollTo(0, 0);\n  };\n\n  TKOControl.closeMobileMenu = function closeMobileMenu() {\n    var mc = document.querySelector(\".main-content\");\n    mc.classList.remove(\"mobile-no-scroll\");\n    mc.classList.remove(\"mobile-hidden\");\n    var sb = document.querySelector(\".sidebar\");\n    sb.style.display = \"\";\n  };\n\n  TKOControl.mobileHeaderSearch = function mobileHeaderSearch() {\n    var mobileHeader = document.querySelector(\".mobile-header\");\n    mobileHeader ? mobileHeader.classList.add(\"search-mode\") : \"\";\n    document.querySelector(\".search-text\").focus();\n  };\n\n  TKOControl.mobileHeaderSearchClose = function mobileHeaderSearchClose() {\n    var mobileHeader = document.querySelector(\".mobile-header\");\n    mobileHeader ? mobileHeader.classList.remove(\"search-mode\") : \"\";\n  };\n\n  return TKOControl;\n}();\nvar changeColorBtn = document.querySelectorAll(\".color-selector-btn\");\n\nfor (var i = 0; i < changeColorBtn.length; i++) {\n  changeColorBtn[i].removeEventListener(\"click\", TKOControl.changeColorHandler);\n  changeColorBtn[i].addEventListener(\"click\", TKOControl.changeColorHandler);\n}\n\nvar textSearchBtn = document.querySelectorAll(\".text-search-btn\");\n\nfor (var _i = 0; _i < textSearchBtn.length; _i++) {\n  textSearchBtn[_i].removeEventListener(\"click\", TKOControl.textSearchHandler);\n\n  textSearchBtn[_i].addEventListener(\"click\", TKOControl.textSearchHandler);\n}\n\nvar searchTextInput = document.querySelectorAll(\".search-text\");\n\nfor (var _i2 = 0; _i2 < searchTextInput.length; _i2++) {\n  searchTextInput[_i2].removeEventListener(\"keypress\", TKOControl.textSearchKeyboardHandler);\n\n  searchTextInput[_i2].addEventListener(\"keypress\", TKOControl.textSearchKeyboardHandler);\n}\n\nvar increaseCharsizeBtn = document.querySelectorAll(\".increase-charsize-btn\");\n\nfor (var _i3 = 0; _i3 < increaseCharsizeBtn.length; _i3++) {\n  increaseCharsizeBtn[_i3].removeEventListener(\"click\", TKOControl.increaseCharSize);\n\n  increaseCharsizeBtn[_i3].addEventListener(\"click\", TKOControl.increaseCharSize);\n}\n\nvar decreaseCharsizeBtn = document.querySelectorAll(\".decrease-charsize-btn\");\n\nfor (var _i4 = 0; _i4 < decreaseCharsizeBtn.length; _i4++) {\n  decreaseCharsizeBtn[_i4].removeEventListener(\"click\", TKOControl.decreaseCharSize);\n\n  decreaseCharsizeBtn[_i4].addEventListener(\"click\", TKOControl.decreaseCharSize);\n}\n\nvar defaultCharsizeBtn = document.querySelectorAll(\".default-charsize-btn\");\n\nfor (var _i5 = 0; _i5 < defaultCharsizeBtn.length; _i5++) {\n  defaultCharsizeBtn[_i5].removeEventListener(\"click\", TKOControl.defaultCharSize);\n\n  defaultCharsizeBtn[_i5].addEventListener(\"click\", TKOControl.defaultCharSize);\n}\n\nvar menuBtn = document.querySelectorAll(\".menu-btn\");\n\nfor (var _i6 = 0; _i6 < menuBtn.length; _i6++) {\n  menuBtn[_i6].removeEventListener(\"click\", TKOControl.openMobileMenu);\n\n  menuBtn[_i6].addEventListener(\"click\", TKOControl.openMobileMenu);\n}\n\nvar searchBtn = document.querySelectorAll(\".mobile-search-btn\");\n\nfor (var _i7 = 0; _i7 < searchBtn.length; _i7++) {\n  searchBtn[_i7].removeEventListener(\"click\", TKOControl.mobileHeaderSearch);\n\n  searchBtn[_i7].addEventListener(\"click\", TKOControl.mobileHeaderSearch);\n}\n\nvar searchCloseBtn = document.querySelectorAll(\".mobile-search-close-btn\");\n\nfor (var _i8 = 0; _i8 < searchCloseBtn.length; _i8++) {\n  searchCloseBtn[_i8].removeEventListener(\"click\", TKOControl.mobileHeaderSearchClose);\n\n  searchCloseBtn[_i8].addEventListener(\"click\", TKOControl.mobileHeaderSearchClose);\n}\n\nvar menuCloseBtn = document.querySelectorAll(\".menu-close-btn\");\n\nfor (var _i9 = 0; _i9 < menuCloseBtn.length; _i9++) {\n  menuCloseBtn[_i9].removeEventListener(\"click\", TKOControl.closeMobileMenu);\n\n  menuCloseBtn[_i9].addEventListener(\"click\", TKOControl.closeMobileMenu);\n}\n\nTKOControl.applyDefaultColor();\nTKOControl.applyDefaultCharSize();\n\nif (location.search === \"?embed=true\") {\n  document.body.classList.add(\"class\", \"embed\");\n}\n\n//# sourceURL=webpack:///./src/tkoctrl.ts?");
